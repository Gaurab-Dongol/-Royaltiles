    ...
    <html <?php language_attributes(); ?>
        ...
        <body <?php body_class(); ?>
            ...
            <div id="page" class="site">
                <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'royaltiles'); ?></a>
                <div class="top-bar">
                            <ul>
                    ...
                    <li><a href="https://www.facebook.com/RoyalTilesAustralia"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <nav id="site-navigation" class="main-navigation">
                                    <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e('Primary Menu', 'royaltiles'); ?></button>
                                    <?php wp_nav_menu([
                                        'theme_location' => 'menu-1',
                                        'menu_id' => 'primary-menu',
                                    ]); ?>
                                    <a href="#" class="shop-icon-menu"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                                    <a class="search-main" href="#search">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/search.svg" class="svg" />
                                    </a>
                                    <div id="search">
                                        <span class="close" id="search-close"><img src="<?php echo get_template_directory_uri(); ?>/images/close.svg" class="svg" /></span>
                                        <form role="search" id="searchform" action="<?php echo home_url('/'); ?>" method="get">
                                            <div class="header-search-search">
                                                ...
                                                <button type="submit" class="search-submit">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/images/search.svg" class="svg" /><span class="screen-reader-text"><?php echo _x('Search', 'submit button', 'ronzappia'); ?></span>
                                                </button>
                                            </div>
                                        </form>
                                    </div>
