	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="foot-list-wrap">
				<ul>
					<li><i class="fa fa-map-marker" aria-hidden="true"></i>Showroom: 255 Parramatta Rd,Auburn NSW 2144</li>
					<li><i class="fa fa-map-marker" aria-hidden="true"></i>Warehouse: 32 Parramatta Rd, Lidcombe NSW 2141</li>
